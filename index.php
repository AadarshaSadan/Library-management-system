...
<body>
	...
	<h1>AKSHAR GYAN LIBRARY MEMBER LOGIN</h1>
	...
	<div class="container">
		...
		<div class="login">
			...
			<form action="index.php" method="post">
				<input type="text" Name="RollNo" placeholder="Phone Number" required="">
	...
	<div class="footer w3layouts agileits">
		<p> &copy; 2021 AKSHAR GYAN READER CLUB. All Rights Reserved </a></p>
	</div>
