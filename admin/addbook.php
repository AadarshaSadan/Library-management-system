                            ...
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" action="addbook.php" method="post">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="price" name="price" placeholder="Rs 1200" class="span8" required>
                                            </div>
                                        </div>
...
<div class="footer">
            <div class="container">
                <b class="copyright">&copy; AKSHAR GYAN READER CLUB </b>All rights reserved.
            </div>
        </div>
...
$sql1="insert into LMS.book (Title,Publisher,Year,Availability,Price) values ('$title','$publisher','$year','$availability','$price')";
